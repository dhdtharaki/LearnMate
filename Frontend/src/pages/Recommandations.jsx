...
export default function Recommendations() {
    ...
    useEffect(() => {
        const fetchActivities = async () => {
            try {
                setLoading(true);
                const response = await axios.get(`/get-activities?email=${userObject.email}`);
                ...
                <main className="flex-1 p-10">
                    <div className="bg-white rounded-xl shadow-2xl p-6 mb-8">
                        <div className="flex justify-between items-center mb-6">
                            <h2 className="text-gray-900 font-extrabold text-2xl tracking-wide flex items-center gap-2">
                    ...
                    <div className="bg-white rounded-xl shadow-2xl p-6">
                        <h2 className="text-gray-800 font-bold text-xl mb-4">Recommendation History:</h2>
                        {loading ? (
                ...
                <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center">
                    <div className="bg-white p-6 rounded-xl shadow-2xl w-96">
                        ...
                        <form onSubmit={handleFormSubmit}>
                            ...
                            <div className="mb-4">
                                <label className="block text-gray-700 font-medium mb-2">Time Taken (Min)</label>
                                <input
                                    type="number"
                                    name="timeTaken"
                            ...
                            <div className="mb-4">
                                <label className="block text-gray-700 font-medium mb-2">Total Points</label>
                                <input
                                    type="number"
                                    name="points"
                            ...
                            <div className="mb-4">
                                <label className="block text-gray-700 font-medium mb-2">Re-tries</label>
                                <input
                                    type="number"
                                    name="retries"
